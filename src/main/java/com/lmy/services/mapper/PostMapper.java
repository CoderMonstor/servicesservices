...
public interface PostMapper {
    ...
    @Results(id = "postMap",value = {
            ...
            @Result(property = "isLiked",column = "{askId = askId,postId = postId}",
                    one = @One(select = "com.lmy.services.mapper.PostMapper.isLiked")),
            ...
            @Result(property = "forwardNum",column = "postId",
                    one = @One(select = "com.lmy.services.mapper.PostMapper.getPostsForwardNum")),
            @Result(property = "commentNum",column = "postId",
                    one = @One(select = "com.lmy.services.mapper.PostMapper.getPostsCommentNum")),
            ...
            @Result(property = "isStar",column = "{askId = askId,postId = postId}",
                    one = @One(select = "com.lmy.services.mapper.PostMapper.isStar")),
