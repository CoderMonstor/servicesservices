...
public interface CommentMapper {
    ...
    @Results(id = "commentMap",value = {
            ...
            @Result(property = "likeNum",column = "commentId",
                    one = @One(select = "com.lmy.services.mapper.CommentMapper.getCommentLikeNum")),
            @Result(property = "isLiked",column = "{askId = askId,commentId = commentId}",
                    one = @One(select = "com.lmy.services.mapper.CommentMapper.isLiked")),
            @Result(property = "replyNum",column = "commentId",
                    one = @One(select = "com.lmy.services.mapper.CommentMapper.getReplyNumByCommentId")),
            @Result(property="replyList",column = "{askId = askId,commentId = commentId}",
                    many = @Many(select = "com.lmy.services.mapper.ReplyMapper.getTopReplyByCommentId"))
    })
